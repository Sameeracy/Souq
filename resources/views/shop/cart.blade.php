<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        @if(request('payment') === 'cancelled')
            <div class="mb-8 p-4 sm:p-5 rounded-2xl bg-amber-50 border border-amber-200 flex items-start space-x-3.5 text-amber-900 shadow-sm animate-fade-in">
                <div class="p-2 rounded-xl bg-amber-100 text-amber-700 shrink-0">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
                </div>
                <div>
                    <h3 class="font-bold text-base text-amber-950">Payment Cancelled</h3>
                    <p class="text-sm text-amber-800 mt-0.5">
                        Your checkout session on Stripe was cancelled. You can review your details and try placing your order again when ready.
                    </p>
                </div>
            </div>
        @endif
