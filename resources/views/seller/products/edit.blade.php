<x-app-layout>
    <x-slot name="title">Edit Product: {{ $product->title }}</x-slot>
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 sm:p-8 dark:border-gray-800 dark:bg-gray-dark shadow-theme-xs">
            <div class="border-b border-gray-100 dark:border-gray-800 pb-5 mb-6 flex items-center justify-between">
                <div>
                    <h1 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white tracking-tight">Edit Product</h1>
                    <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1">Update details, image, or configure product options and variant-specific pricing</p>
                </div>
