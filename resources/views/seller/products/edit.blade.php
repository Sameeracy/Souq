    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="bg-white rounded-3xl border border-slate-200/80 shadow-sm p-6 sm:p-10">
            <div class="border-b border-slate-100 pb-6 mb-8 flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-black text-slate-900 tracking-tight">Edit Product</h1>
                    <p class="text-sm text-slate-500 mt-1">Update details, image, or configure product options and variant-specific pricing</p>
                </div>
                ...
                <div class="bg-slate-50 rounded-2xl p-5 sm:p-6 border border-slate-200/80">
                    <div class="flex items-center justify-between mb-3">
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-0.5">Manage existing or add new options with optional variant prices (Rs.)</p>
                        </div>
